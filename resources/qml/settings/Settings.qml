    ...
    Rectangle {
        ...
        Column {
			...
			SettingsEntry {
				...
				property bool isEnabled: cp_toggle.checked
            ...
            SettingsEntry {
                ...
                function disable(isEnabled) {
                    opacity = isEnabled ? 1 : .25
					le_toggle.visible = isEnabled
					if (isEnabled) { le_toggle.checked = false }
                }
