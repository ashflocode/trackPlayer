...
Item {
	...
	Row {
		Text {
			...
			text: Controller.tracklist.metadataFields[modelData] + ": "
		}
		...
		Text {
			...
			Component.onCompleted: {
				objectName = Controller.tracklist.metadataFields[modelData] + "_text"
				metadata_window.metadataText[Controller.tracklist.metadataFields[modelData]] = metadata_text;
			}
		}
		...
		Item {
			...
			Component.onCompleted: {
				metadata_window.metadataEdit[Controller.tracklist.metadataFields[modelData]] = metadata_edit;
			}
		}
	}
}