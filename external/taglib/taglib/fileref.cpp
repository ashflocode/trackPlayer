...
namespace
{
...
#ifndef TAGLIB_USE_EXTERNAL_FILE_IO
  template <typename T>
  ...
  template <>
  String toFileNameString<IOStream *>(IOStream *arg)
  {
	  return String();
  }

  template <>
  String toFileNameString<FileName>(FileName arg)
  {
	  return String(arg.utf8Name(), TagLib::String::UTF8);
  }
#endif
                       ...
                       AudioProperties::ReadStyle audioPropertiesStyle)
  {
...
#ifdef TAGLIB_USE_EXTERNAL_FILE_IO
    const String s = toFileNameString(arg);
#elif defined(_WIN32)
	...
	if(ext == "AAC")
		return new MPEG::File(arg, ID3v2::FrameFactory::instance(), readAudioProperties, audioPropertiesStyle, MPEG::File::ADTS);
	if(ext == "OGG")
