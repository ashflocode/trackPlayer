  ...
  unsigned int offset, int byteAlign)
{
  ...
  // AIRDJ-31981 findVectorFast() only does byte based search, without consideration of byteAlign
  // For example: UTF16 encoding, byteAlign == 2, pattern = [/0][/0], data = [d][/0][/0][/0]
