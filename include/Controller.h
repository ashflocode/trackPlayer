...
class Controller : public QObject
{
    ...
    Q_PROPERTY(QString artist MEMBER _artist)
    Q_PROPERTY(QString title MEMBER _title)
    Q_PROPERTY(QString album MEMBER _album)
    Q_PROPERTY(QString genre MEMBER _genre)
    Q_PROPERTY(QString year MEMBER _year)
...
public:
    ...
    Q_INVOKABLE QString setPlaybackLength();
    ...
    Q_INVOKABLE void getMetadata(const QString& filePath, const QString& databaseTable, bool updateDeck);
